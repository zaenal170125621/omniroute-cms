...
<footer class="site-footer">
    <div class="container">
        ...
        <div class="footer-newsletter" style="margin-top:32px;padding-top:32px;border-top:1px solid var(--gray-200);">
            ...
            <form class="newsletter-form" action="{{ route('newsletter.subscribe') }}" method="POST" data-toast="{{ __('Cek email Anda untuk konfirmasi langganan.') }}">
                @csrf
                <input type="text" name="company_site" value="" tabindex="-1" autocomplete="off" style="position:absolute;left:-9999px;" aria-hidden="true">
