...
<div class="pricing-sticky-cta" id="pricing-sticky-cta" role="complementary" aria-label="{{ __('Quick action') }}">
    ...
    @php $waLink = wa_link(); @endphp
    @if ($waLink)
    <a href="{{ $waLink }}" target="_blank" rel="noopener" class="btn btn-outline btn-sm" style="flex:1;display:flex;align-items:center;justify-content:center;gap:6px;">
