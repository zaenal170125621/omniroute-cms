...
{
    /**
     * Satu-satunya sumber data paket — dipakai halaman order & pricing
     * supaya harga/fitur tidak bisa tidak sinkron.
     */
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            'package' => ['required', 'in:' . implode(',', array_column(self::PACKAGES, 'code'))],
